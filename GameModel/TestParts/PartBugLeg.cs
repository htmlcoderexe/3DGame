...
namespace GameModel.TestParts
{
    public class PartBugLeg : ModelPart
    {
        public PartBugLeg(bool Flip=false)
        {
            ...
            //origin vertex
            _vertices[0] = new ModelVertex(new Vector3(0.0f, 0.50f, -0.00f), Color.Black);
            _vertices[0].BoneWeightData.X = 0;
            //middle 3
            _vertices[1] = new ModelVertex(new Vector3(0.2f, 0.8f + 0.02f, -0.00f), Color.Black);
            _vertices[1].BoneWeightData.X = 0.33f;
            _vertices[2] = new ModelVertex(new Vector3(0.2f, 0.8f + 0.00f, -0.02f), Color.Black);
            _vertices[2].BoneWeightData.X = 0.33f;
            _vertices[3] = new ModelVertex(new Vector3(0.2f, 0.8f + 0.00f, 0.02f), Color.Black);
            _vertices[3].BoneWeightData.X = 0.33f;
            //middle 3
            _vertices[4] = new ModelVertex(new Vector3(0.4f, 0.2f + 0.02f, -0.00f), Color.Black);
            _vertices[4].BoneWeightData.X = 0.67f;
            _vertices[5] = new ModelVertex(new Vector3(0.4f, 0.2f + 0.00f, -0.02f), Color.Black);
            _vertices[5].BoneWeightData.X = 0.67f;
            _vertices[6] = new ModelVertex(new Vector3(0.4f, 0.2f + 0.00f, 0.02f), Color.Black);
            _vertices[6].BoneWeightData.X = 0.67f;
            //tip
            _vertices[7] = new ModelVertex(new Vector3(0.5f, 0.00f, -0.00f), Color.Black);
